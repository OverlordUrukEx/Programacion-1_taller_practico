import Encapsulamiento_y_Modificadores_de_Acceso

# crear una instancia de la clase Carro
mi_carro = Encapsulamiento_y_Modificadores_de_Acceso.Carro("Toyota", "Corolla", 2020)
# crear una segunda instancia de la clase Carro
mi_carro1 = Encapsulamiento_y_Modificadores_de_Acceso.Carro("Honda", "Camry", 2021)
